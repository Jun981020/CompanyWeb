...
<c:import url="../header.jsp" />
  ...
  <script>
    ...
    function checkValue() {
    	...
    	/* if(document.userInfo.member_id_check.value == 'no') { 
    ...
    <div class="information1">
      ...
      <table>
        ...
        <tr>
          <td>이메일 수신여부</td>
          <td>
          	<input type="radio" checked name="member_email_receive" value=1 >수신
            <input type="radio" name="member_email_receive" value=0 >수신안함
          </td>
        </tr>
        <tr>
          <td>비밀번호 확인시 질문</td>
        ...
        <tr>
          <td>비밀번호 확인시 답변</td>
          <td><input type="text" name="member_pw_answer" id="member_pw_answer" value=""></td>
        </tr>
        <tr>
          <td>성별</td>
          <td><input type="radio" name="member_gender" value="male" checked>남자
