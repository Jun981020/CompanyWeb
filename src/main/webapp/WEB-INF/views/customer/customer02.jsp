...
<body>
  ...
  <div class="communitySection2 container text-center">
    ...
    <div class="qna">
      <table>
        ...
        <tr onclick="window.open('customer02_3?qna_idx=${ dto.qna_idx }','비밀번호 확인', 'width=460, height=300,location=no,status=no,scrollbars=no')">
        	<td>${dto.qna_idx}</td>
        	<td >
  ...
  <script>
    function openWindow( no ){
      ...
      window.open('customer02_3?qna_idx='+no, '비밀번호확인', 'width=430,height=300,location=no,status=no,scrollbars=no')
    }
  </script>
