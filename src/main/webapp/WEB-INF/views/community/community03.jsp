  ...
  <div class="commonSection1">
    <div class="commonContent1">
      ...
      <div class="commonContent2 text-center">
        ...
        <div>
          <p><img src="/img/icon-home.png"> > 커뮤니티 > 구인광고</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <ul class="navbar-nav mr-auto navbar-nav-scroll" 
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu asd">
            <li><a class="dropdown-item" href="/community/community01.html">구인광고</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="#">구인광고</a></li>
            <li><hr class="dropdown-divider"></li>
    ...
    <div class="Notice">
     <table>
        ...
        <c:forEach var = "dto" items = "${list}">
        	<tr>
        		<td>${dto.job_idx}</td>
        		<td onclick="window.location.href='community03_1?job_idx=${dto.job_idx}'">
        		${dto.job_title}
        		</td>
        		<td><fmt:formatDate value="${dto.job_date}" pattern="yyyy년MM월dd일"/></td>
        	</tr>
        </c:forEach>
        </table>
    </div>
